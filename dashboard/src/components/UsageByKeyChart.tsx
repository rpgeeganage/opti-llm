...
import { ApiKeyUsage } from '../services/api';

const UsageByKeyChart: React.FC<{ usage: ApiKeyUsage[] }> = ({ usage }) => {
  ...
  useEffect(() => {
    ...
    tokensSeries.columns.template.setAll({
      strokeWidth: 0,
    ...
    tokensSeries.data.setAll(usage);
    costSeries.data.setAll(usage);
...
export default UsageByKeyChart;
